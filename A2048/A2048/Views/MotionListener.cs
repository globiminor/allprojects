...
namespace A2048.Views
{
  class MotionListener : Java.Lang.Object, View.IOnGenericMotionListener, View.IOnTouchListener
  {
    ...
    {
      MainView mainView = _parent.MainView;
      if (_t1Down == null)
      {
        TouchReset();
        return true;
      ...
      if (_t2Down == null)
      {
        ...
        float prec = System.Math.Min(rect.Height(), rect.Width()) / mainView.Precision;

        if (mainView.IsTouchHandled())
        { }
...

      {
        ...
        mainView.TouchReset(); // Scale(scale, centerX, centerY);
      }
    ...
    public bool OnTouch(View v, MotionEvent e)
    {
      ...
      if (e.Action == MotionEventActions.Down)
      {
        ...
        mainView.OnTouch(_t1Down.X, _t1Down.Y, _t1Down.Action);
        return HandleAction();
      }
      if (e.Action == MotionEventActions.Move)
      {
        Touch move = Touch.Create(e, 0);
        mainView.OnTouch(move.X, move.Y, move.Action);
        return true;
      }
