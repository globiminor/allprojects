...
{
	/// <summary>
	/// Summary description for SdeRaster.
	/// </summary>
	public class SdeRaster
	{
		/* $Id: sderaster.h,v 1.45 2003/12/29 07:39:17 eddy3249 Exp $ */
		/***********************************************************************
		*
		...
		************************************************************/
		...
		public const int SE_RASTERBAND_CREATED     = 1;
		public const int SE_RASTERBAND_MODIFIED    = 2;

		/************************************/
		/***  Image Pyramid Auto Level   ****/
		/************************************/

		public const int SE_PYRAMID_AUTO_LEVEL     = -1;

		/************************************/
		/***  Pixel Type in Raster Band   ***/
		/************************************/

		public const int SE_PIXEL_TYPE_1BIT              = 0x008;
		public const int SE_PIXEL_TYPE_4BIT              = 0x020;
		public const int SE_PIXEL_TYPE_8BIT_U            = 0x040;
		public const int SE_PIXEL_TYPE_8BIT_S            = 0x041;
		public const int SE_PIXEL_TYPE_16BIT_U           = 0x080;
		public const int SE_PIXEL_TYPE_16BIT_S           = 0x081;
		public const int SE_PIXEL_TYPE_32BIT_U           = 0x100;
		public const int SE_PIXEL_TYPE_32BIT_S           = 0x101;
		public const int SE_PIXEL_TYPE_32BIT_REAL        = 0x102;
		public const int SE_PIXEL_TYPE_64BIT_REAL        = 0x200;

		/*****************************************************/
		/***  Macro to obtain BitsPerPixel from Pixel Type ***/
		/*****************************************************/

		public static int SE_PIXEL_TYPE_GET_DEPTH(int type)
		{
			return type >> 3;
		}
		...
		public enum SE_COMPRESSION_TYPE
		{
		...
		public static int SE_COMPRESSION_SET_PARAM_VALUE(int type,int value)
		{
			return (type & 0x0000FFFF) | (value << 16);
		}
		...
		public const int SE_GDBTYPE_NONE       = 0;
		public const int SE_GDBTYPE_RASTERMAP  = 1;
