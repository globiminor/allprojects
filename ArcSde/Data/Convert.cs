...
namespace ArcSde.Data
{
  static class Convert
  {
    ...
    public static IGeometry ToGeom(SeShape shape)
    {
      ...
      Check(CApi.SE_shape_get_num_parts(shape.Ptr, out nrParts, out nrSubparts));
      ...
      for (int iPart = 1; iPart <= nrParts; iPart++)
      {
        ...
        ErrorHandling.checkRC(IntPtr.Zero, IntPtr.Zero, CApi.SE_shape_get_num_points(shape.Ptr, iPart, 0, out nrPoints));
